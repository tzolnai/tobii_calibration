...
class getAvgEyeDistTest(unittest.TestCase):
    ...
    def testValidGazeData(self):
        ...
        self.assertAlmostEqual(66.830, avgResult, delta = 0.001)
    ...
    def testGazeDataWithNoLeftEye(self):
        ...
        avgResult = tobii_helper.getAvgEyeDist()
        self.assertAlmostEqual(66.708, avgResult, delta = 0.001)
    ...
    def testGazeDataNullXY(self):
        ...
        avgResult = tobii_helper.getAvgEyeDist()
        self.assertAlmostEqual(71.0, avgResult, delta = 0.001)
    ...
    def testGazeDataNullX(self):
        ...
        avgResult = tobii_helper.getAvgEyeDist()
        self.assertAlmostEqual(71.236, avgResult, delta = 0.001)
