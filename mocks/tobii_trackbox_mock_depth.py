...
class EyeTrackerMock:
    def subscribe_to(self, subscription_type, callback, as_dictionary=False):
        gazeData = {}
        gazeData['left_gaze_origin_in_trackbox_coordinate_system'] = (0.5, 0.5, 0.5)
        gazeData['right_gaze_origin_in_trackbox_coordinate_system'] = (0.5, 0.5, 0.5)
        gazeData['left_gaze_origin_in_user_coordinate_system'] = (0.0, 0.0, 750.0)
        gazeData['right_gaze_origin_in_user_coordinate_system'] = (0.0, 0.0, 750.0)
...
def on_move(x, y):
    ...
    gazeData['left_gaze_origin_in_user_coordinate_system'] = (0.0, 0.0, yCoord)
    gazeData['right_gaze_origin_in_user_coordinate_system'] = (0.0, 0.0, yCoord)
    gazeData['left_gaze_origin_validity'] = True
    gazeData['right_gaze_origin_validity'] = True
